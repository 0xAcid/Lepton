...
# Lepton/Makefile.  Generated from Makefile.in by configure.
...
noinst_PROGRAMS = Lepton-amd64-linux$(EXEEXT) \
	$(am__EXEEXT_1)
#am__append_5 = Lepton--linux
Lepton__linux_DEPENDENCIES =
subdir = Lepton
...
#am__EXEEXT_1 = Lepton--linux$(EXEEXT)
PROGRAMS = $(noinst_PROGRAMS)
am__objects_1 =  \
	Lepton_amd64_linux-LT_main.$(OBJEXT)
am_Lepton_amd64_linux_OBJECTS = $(am__objects_1)
Lepton_amd64_linux_OBJECTS =  \
	$(am_Lepton_amd64_linux_OBJECTS)
am__Lepton__linux_SOURCES_DIST = LT_main.c
am__objects_2 =  \
	Lepton__linux-LT_main.$(OBJEXT)
#am_Lepton__linux_OBJECTS =  \
#	$(am__objects_2)
Lepton__linux_OBJECTS =  \
	$(am_Lepton__linux_OBJECTS)
AM_V_P = $(am__v_P_$(V))
...
am__v_CCLD_1 = 
SOURCES = $(Lepton_amd64_linux_SOURCES) \
	$(Lepton__linux_SOURCES)
DIST_SOURCES = $(Lepton_amd64_linux_SOURCES) \
	$(am__Lepton__linux_SOURCES_DIST)
...
am__relativize = \
  ...
  reldir="$$dir2"
ACLOCAL = ${SHELL} /opt/valgrind/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /opt/valgrind/missing autoconf
AUTOHEADER = ${SHELL} /opt/valgrind/missing autoheader
AUTOMAKE = ${SHELL} /opt/valgrind/missing automake-1.14
AWK = mawk
BOOST_CFLAGS = 
BOOST_LIBS = 
CC = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /opt/valgrind/missing makeinfo
MKDIR_P = /bin/mkdir -p
MPI_CC = mpicc
OBJEXT = o
PACKAGE = valgrind
...
PACKAGE_STRING = Valgrind 3.13.0.SVN
PACKAGE_TARNAME = valgrind
PACKAGE_URL = 
PACKAGE_VERSION = 3.13.0.SVN
PATH_SEPARATOR = :
PERL = /usr/bin/perl
...
VG_TMPDIR = /tmp
abs_builddir = /opt/valgrind/Lepton
abs_srcdir = /opt/valgrind/Lepton
abs_top_builddir = /opt/valgrind
abs_top_srcdir = /opt/valgrind
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /opt/valgrind/install-sh
...
Lepton_amd64_linux_SOURCES = \
        $(Lepton_SOURCES_COMMON)

Lepton_amd64_linux_CPPFLAGS = \
        $(AM_CPPFLAGS_AMD64_LINUX)

Lepton_amd64_linux_CFLAGS = \
        $(AM_CFLAGS_AMD64_LINUX)

Lepton_amd64_linux_DEPENDENCIES = \
        $(TOOL_DEPENDENCIES_AMD64_LINUX)

Lepton_amd64_linux_LDADD = \
        $(TOOL_LDADD_AMD64_LINUX)

Lepton_amd64_linux_LDFLAGS = \
        $(TOOL_LDFLAGS_AMD64_LINUX)

Lepton_amd64_linux_LINK = \
...
#Lepton__linux_CPPFLAGS = \
#        $(AM_CPPFLAGS_)

#Lepton__linux_CFLAGS = \
#        $(AM_CFLAGS_)
...
$(srcdir)/Makefile.in: # $(srcdir)/Makefile.am $(top_srcdir)/Makefile.tool.am $(top_srcdir)/Makefile.all.am $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign Lepton/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign Lepton/Makefile
.PRECIOUS: Makefile
...
Lepton-amd64-linux$(EXEEXT): $(Lepton_amd64_linux_OBJECTS) $(Lepton_amd64_linux_DEPENDENCIES) $(EXTRA_Lepton_amd64_linux_DEPENDENCIES) 
	@rm -f Lepton-amd64-linux$(EXEEXT)
	$(AM_V_GEN)$(Lepton_amd64_linux_LINK) $(Lepton_amd64_linux_OBJECTS) $(Lepton_amd64_linux_LDADD) $(LIBS)

Lepton--linux$(EXEEXT): $(Lepton__linux_OBJECTS) $(Lepton__linux_DEPENDENCIES) $(EXTRA_Lepton__linux_DEPENDENCIES) 
	@rm -f Lepton--linux$(EXEEXT)
	$(AM_V_GEN)$(Lepton__linux_LINK) $(Lepton__linux_OBJECTS) $(Lepton__linux_LDADD) $(LIBS)
...
include ./$(DEPDIR)/Lepton_amd64_linux-LT_main.Po
include ./$(DEPDIR)/Lepton__linux-LT_main.Po
...
Lepton_amd64_linux-LT_main.o: LT_main.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(Lepton_amd64_linux_CPPFLAGS) $(CPPFLAGS) $(Lepton_amd64_linux_CFLAGS) $(CFLAGS) -MT Lepton_amd64_linux-LT_main.o -MD -MP -MF $(DEPDIR)/Lepton_amd64_linux-LT_main.Tpo -c -o Lepton_amd64_linux-LT_main.o `test -f 'LT_main.c' || echo '$(srcdir)/'`LT_main.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/Lepton_amd64_linux-LT_main.Tpo $(DEPDIR)/Lepton_amd64_linux-LT_main.Po
#	$(AM_V_CC)source='LT_main.c' object='Lepton_amd64_linux-LT_main.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(Lepton_amd64_linux_CPPFLAGS) $(CPPFLAGS) $(Lepton_amd64_linux_CFLAGS) $(CFLAGS) -c -o Lepton_amd64_linux-LT_main.o `test -f 'LT_main.c' || echo '$(srcdir)/'`LT_main.c

Lepton_amd64_linux-LT_main.obj: LT_main.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(Lepton_amd64_linux_CPPFLAGS) $(CPPFLAGS) $(Lepton_amd64_linux_CFLAGS) $(CFLAGS) -MT Lepton_amd64_linux-LT_main.obj -MD -MP -MF $(DEPDIR)/Lepton_amd64_linux-LT_main.Tpo -c -o Lepton_amd64_linux-LT_main.obj `if test -f 'LT_main.c'; then $(CYGPATH_W) 'LT_main.c'; else $(CYGPATH_W) '$(srcdir)/LT_main.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/Lepton_amd64_linux-LT_main.Tpo $(DEPDIR)/Lepton_amd64_linux-LT_main.Po
#	$(AM_V_CC)source='LT_main.c' object='Lepton_amd64_linux-LT_main.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(Lepton_amd64_linux_CPPFLAGS) $(CPPFLAGS) $(Lepton_amd64_linux_CFLAGS) $(CFLAGS) -c -o Lepton_amd64_linux-LT_main.obj `if test -f 'LT_main.c'; then $(CYGPATH_W) 'LT_main.c'; else $(CYGPATH_W) '$(srcdir)/LT_main.c'; fi`

Lepton__linux-LT_main.o: LT_main.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(Lepton__linux_CPPFLAGS) $(CPPFLAGS) $(Lepton__linux_CFLAGS) $(CFLAGS) -MT Lepton__linux-LT_main.o -MD -MP -MF $(DEPDIR)/Lepton__linux-LT_main.Tpo -c -o Lepton__linux-LT_main.o `test -f 'LT_main.c' || echo '$(srcdir)/'`LT_main.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/Lepton__linux-LT_main.Tpo $(DEPDIR)/Lepton__linux-LT_main.Po
#	$(AM_V_CC)source='LT_main.c' object='Lepton__linux-LT_main.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(Lepton__linux_CPPFLAGS) $(CPPFLAGS) $(Lepton__linux_CFLAGS) $(CFLAGS) -c -o Lepton__linux-LT_main.o `test -f 'LT_main.c' || echo '$(srcdir)/'`LT_main.c

Lepton__linux-LT_main.obj: LT_main.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(Lepton__linux_CPPFLAGS) $(CPPFLAGS) $(Lepton__linux_CFLAGS) $(CFLAGS) -MT Lepton__linux-LT_main.obj -MD -MP -MF $(DEPDIR)/Lepton__linux-LT_main.Tpo -c -o Lepton__linux-LT_main.obj `if test -f 'LT_main.c'; then $(CYGPATH_W) 'LT_main.c'; else $(CYGPATH_W) '$(srcdir)/LT_main.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/Lepton__linux-LT_main.Tpo $(DEPDIR)/Lepton__linux-LT_main.Po
#	$(AM_V_CC)source='LT_main.c' object='Lepton__linux-LT_main.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(Lepton__linux_CPPFLAGS) $(CPPFLAGS) $(Lepton__linux_CFLAGS) $(CFLAGS) -c -o Lepton__linux-LT_main.obj `if test -f 'LT_main.c'; then $(CYGPATH_W) 'LT_main.c'; else $(CYGPATH_W) '$(srcdir)/LT_main.c'; fi`
